# This file contains the implementation of a feedforward neural network using PyTorch.
# The contents of this file are based off the template given in the NeuralNetwork lab activity from DLSU's STINTSY course.
